...
public class HiringTest extends TestCase {
    ...
    public void testWhereGivenCompany() {
        try {
            ...
            assertEquals(FundingRaisedRefactored.where(options).size(), 7);
        } catch(IOException e) {
    ...
    public void testWhereGivenCity() {
        try {
            ...
            assertEquals(FundingRaisedRefactored.where(options).size(), 3);
        } catch(IOException e) {
            System.out.print(e.getMessage());
    ...
    public void testWhereGivenState() {
        try {
            ...
            assertEquals(FundingRaisedRefactored.where(options).size(), 873);
        } catch(IOException e) {
            System.out.print(e.getMessage());
    ...
    public void testWhereGivenRound() {
        try {
            Map<String, String> options = new HashMap<> ();
            options.put("round", "a");
            assertEquals(FundingRaisedRefactored.where(options).size(), 582);
        } catch(IOException e) {
            System.out.print(e.getMessage());
    ...
    public void testMultipleOptions() {
        try {
            ...
            options.put("round", "a");
            options.put("company_name", "Facebook");
            assertEquals(FundingRaisedRefactored.where(options).size(), 1);
        } catch(IOException e) {
            System.out.print(e.getMessage());
    ...
    public void testWhereNotExists() {
        try {
            ...
            assertEquals(FundingRaisedRefactored.where(options).size(), 0);
        } catch(IOException e) {
            System.out.print(e.getMessage());
    ...
    public void testWhereCorrectKeys() {
        try {
            Map<String, String> options = new HashMap<> ();
            options.put("company_name", "Facebook");
            Map<String, String> row = FundingRaisedRefactored.where(options).get(0);
    ...
    public void testFindByGivenCompanyName() {
        try {
            Map<String, String> options = new HashMap<> ();
            options.put("company_name", "Facebook");
            Map<String, String> row = FundingRaisedRefactored.findBy(options);
